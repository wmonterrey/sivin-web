...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <i class="icon-magnifier"></i> <spring:message code="supenc" />
                ...
                <div class="card-body">
                  <div class="row">
                  	<div class="col-md-10">
	                  	<form action="#" autocomplete="off" id="encuestas-form">
		                  	<div class="form-group">
		                      <div class="input-group">
		                        <span class="input-group-addon"><input type="checkbox" id="checkCodigo" name="checkCodigo" value=""></span>
		                        <input type="text" id="codigo" name="codigo" disabled class="form-control" placeholder="<spring:message code="codigo" />">
		                      </div>
		                    </div>
		                    <div class="form-group">
		                      <div class="input-group">
		                        <span class="input-group-addon"><input type="checkbox" id="checkNombre" name="checkNombre" value=""></span>
		                  ...
		                  <div class="row float-right mr-4" >  
		                    	<button type="submit" class="btn btn-primary" id="buscarencuestas""><i class="fa fa-check"></i>&nbsp;<spring:message code="ok" /></button>
				          </div>
	                  	</form>
                  	</div>
                  </div>
  ...
  <spring:url value="/resources/js/views/Encuestas.js" var="processSearch" />
...
<script>
	jQuery(document).ready(function() {
		var parametros = {opcMuniUrl: "${opcMuniUrl}", opcSegUrl: "${opcSegUrl}", opcRegUrl: "${opcRegUrl}", opcDepUrl: "${opcDepUrl}",
				opcProcUrl: "${opcProcUrl}",encuestasUrl: "${encuestasUrl}",successmessage: "${successmessage}",
