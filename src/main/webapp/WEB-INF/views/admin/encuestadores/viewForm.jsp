	            ...
	            <div class="col-md-12">
	              <div class="card">
	                <div class="card-header">
	                  <i class="icon-note"></i>&nbsp;<strong><c:out value="${encuestador.nombre}" /></strong>
	                </div>
	                	<div class="card-body">
		                	<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                		<div class="form-group row">
			                      ...
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${encuestador.ident}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
			                      <label class="col-md-3 col-form-label"><spring:message code="codigo" />:</label>
			                      <div class="col-md-9">
			                        <p class="form-control-static"><strong><c:out value="${encuestador.codigo}" /></strong></p>
			                      </div>
			                    </div>
			                    <div class="form-group row">
