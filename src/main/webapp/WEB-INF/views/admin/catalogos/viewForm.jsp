	                	...
	                	<table id="lista_respuestas" class="table table-striped table-bordered datatable" width="100%">
			                ...
			                <tbody>
								...
								<tr>
									...
									<c:choose>
										<c:when test="${respuesta.pasive=='0'.charAt(0)}">
											<td><a data-toggle="modal" data-whatever="${fn:escapeXml(disableRespuestaUrl)}" class="btn btn-outline-primary btn-sm desact"><i class="fa fa-trash-o"></i></a></td>
										</c:when>
										<c:otherwise>
											<td><a data-toggle="modal" data-whatever="${fn:escapeXml(enableRespuestaUrl)}" class="btn btn-outline-primary btn-sm act"><i class="fa fa-check"></i></a></td>
										</c:otherwise>
									</c:choose>
								</tr>
							</c:forEach>
